	...
	return (
		<div className='flex flex-col h-screen pb-4'>
			...
			<div className='text-center mb-4'>
				...
				<p>
					For the month of{' '}
					{new Date(0, parseInt(bill.month) - 1).toLocaleString(
						'default',
						{
							month: 'long',
						}
				...
				<table className='w-full border-collapse border'>
					<thead>
						<tr>
							...
							<th className='border p-2 text-center w-[60%]'>
								Description
							</th>
							<th className='border p-2 text-center w-[35%]'>
								Value
							</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td className='border p-2 text-right'>
								{Number(bill.societyMaintenanceCharges).toFixed(
									2
								)}
							</td>
						</tr>
